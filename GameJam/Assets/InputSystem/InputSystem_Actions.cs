...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""BalancingMicrogame"",
            ""id"": ""74395334-1eb0-4ac5-9d24-f5928429e2f6"",
            ""actions"": [
                {
                    ""name"": ""Mouse"",
                    ""type"": ""Value"",
                    ""id"": ""3e8dbefc-31b4-46d1-ad14-a1c5141cedf4"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""82032a38-c464-43dc-8f17-cfb811a84717"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
        ...
        {
            ""name"": ""Menus"",
            ""id"": ""c96366d2-7e66-4239-b9d4-f6fa904b7647"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""1a463980-d60e-4b03-b3ba-b14dd9a7e5d4"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""e9a6d1da-84f0-4a3a-b7ff-53c57e8ab116"",
    ...
    ""controlSchemes"": [
        ...
        // BalancingMicrogame
        m_BalancingMicrogame = asset.FindActionMap("BalancingMicrogame", throwIfNotFound: true);
        m_BalancingMicrogame_Mouse = m_BalancingMicrogame.FindAction("Mouse", throwIfNotFound: true);
        // Menus
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_BalancingMicrogame.enabled, "This will cause a leak and performance issues, InputSystem_Actions.BalancingMicrogame.Disable() has not been called.");
    ...
    // BalancingMicrogame
    private readonly InputActionMap m_BalancingMicrogame;
    private List<IBalancingMicrogameActions> m_BalancingMicrogameActionsCallbackInterfaces = new List<IBalancingMicrogameActions>();
    private readonly InputAction m_BalancingMicrogame_Mouse;
    /// <summary>
    /// Provides access to input actions defined in input action map "BalancingMicrogame".
    /// </summary>
    public struct BalancingMicrogameActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BalancingMicrogameActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "BalancingMicrogame/Mouse".
        /// </summary>
        public InputAction @Mouse => m_Wrapper.m_BalancingMicrogame_Mouse;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_BalancingMicrogame; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="BalancingMicrogameActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(BalancingMicrogameActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="BalancingMicrogameActions" />
        public void AddCallbacks(IBalancingMicrogameActions instance)
        {
            if (instance == null || m_Wrapper.m_BalancingMicrogameActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BalancingMicrogameActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="BalancingMicrogameActions" />
        private void UnregisterCallbacks(IBalancingMicrogameActions instance)
        {
            @Mouse.started -= instance.OnMouse;
            @Mouse.performed -= instance.OnMouse;
            @Mouse.canceled -= instance.OnMouse;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="BalancingMicrogameActions.UnregisterCallbacks(IBalancingMicrogameActions)" />.
        /// </summary>
        /// <seealso cref="BalancingMicrogameActions.UnregisterCallbacks(IBalancingMicrogameActions)" />
        public void RemoveCallbacks(IBalancingMicrogameActions instance)
        {
            if (m_Wrapper.m_BalancingMicrogameActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="BalancingMicrogameActions.AddCallbacks(IBalancingMicrogameActions)" />
        /// <seealso cref="BalancingMicrogameActions.RemoveCallbacks(IBalancingMicrogameActions)" />
        /// <seealso cref="BalancingMicrogameActions.UnregisterCallbacks(IBalancingMicrogameActions)" />
        public void SetCallbacks(IBalancingMicrogameActions instance)
        {
            foreach (var item in m_Wrapper.m_BalancingMicrogameActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BalancingMicrogameActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="BalancingMicrogameActions" /> instance referencing this action map.
    /// </summary>
    public BalancingMicrogameActions @BalancingMicrogame => new BalancingMicrogameActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "BalancingMicrogame" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BalancingMicrogameActions.AddCallbacks(IBalancingMicrogameActions)" />
    /// <seealso cref="BalancingMicrogameActions.RemoveCallbacks(IBalancingMicrogameActions)" />
    public interface IBalancingMicrogameActions
    {
        /// <summary>
